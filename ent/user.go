...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldFirstName, user.FieldMiddleName, user.FieldLastName, user.FieldEmail, user.FieldUsername, user.FieldPhone, user.FieldPassword, user.FieldUserType, user.FieldGoogleID:
...
func (u *User) String() string {
	...
	builder.WriteString(", ")
	if v := u.UserType; v != nil {
		builder.WriteString("user_type=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
	if v := u.GoogleID; v != nil {
